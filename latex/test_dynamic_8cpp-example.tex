...
\textcolor{keyword}{extern} \hyperlink{group__memorygroup_class_grading___order___data___allocator}{Grading\_Order\_Data\_Allocator<DEG\_TYPE>} * 
      \hyperlink{group__memorygroup_gab09a3dd19e9c8880eec08c13bcb42f36}{doda};
...
\textcolor{keywordtype}{bool} meaningful\_arguments(
  ...
  \hyperlink{group__strategygroup_ga0ee6c8e033547330e6b89929730007f4}{StrategyFlags} &, \hyperlink{group___g_b_computation_ga498e6d10e581ed9dca25264cbe825ce0}{DynamicHeuristic} &, 
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char} *argv[]) \{
  ...
  \hyperlink{group___g_b_computation_ga498e6d10e581ed9dca25264cbe825ce0}{DynamicHeuristic} heuristic = DynamicHeuristic::ORD\_HILBERT\_THEN\_DEG;
  ...
  \} \textcolor{keywordflow}{else} \{
    ...
    list<Constant\_Polynomial *> G = \hyperlink{group___g_b_computation_ga40140d94eac91d7337f553d362128cb7}{buchberger\_dynamic}(
        F, method, strategy, grading, (\hyperlink{group___g_b_computation_ga498e6d10e581ed9dca25264cbe825ce0}{DynamicHeuristic} )heuristic, solver
    );
...
\textcolor{comment}{      cout << '\(\backslash\)t' << *(*g) << endl;*/}
  ...
  \textcolor{keywordflow}{if} (doda != \textcolor{keyword}{nullptr}) \textcolor{keyword}{delete} \hyperlink{group__memorygroup_gab09a3dd19e9c8880eec08c13bcb42f36}{doda};
...
\textcolor{keywordtype}{bool} meaningful\_arguments(
    ...
    \hyperlink{group___g_b_computation_ga498e6d10e581ed9dca25264cbe825ce0}{DynamicHeuristic} & heuristic, \hyperlink{group___g_b_computation_ga28fbbb9eb7d8b80ced05c8fa89b2bdac}{DynamicSolver} & solver
) \{
  modulus = 43;
      ...
      \textcolor{keywordflow}{if} (!strcmp(argv[i],\textcolor{stringliteral}{"hom"}) or !strcmp(argv[i],\textcolor{stringliteral}{"homog"})
        ...
        \textcolor{keywordflow}{else} \{
          ...
          \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (!strcmp(argv[i], \textcolor{stringliteral}{"heur"}) or !strcmp(argv[i],\textcolor{stringliteral}{"heuristic"})) \{
            heuristic = (\hyperlink{group___g_b_computation_ga498e6d10e581ed9dca25264cbe825ce0}{DynamicHeuristic})atoi(&(argv[i][j+1]));
            \textcolor{keywordflow}{if} (
                heuristic <= DynamicHeuristic::MIN\_HEURISTIC or
                heuristic >= DynamicHeuristic::MAX\_HEURISTIC
            ) \{
