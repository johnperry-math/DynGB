...
protected:
  ...
  */
  ...
  /**
    @brief builds a reducer for the specified column
        in the specified buffer (@c RB)
  */
  void build_reducer(unsigned buffer, unsigned column);
  /**
  ...
  */
  void reduce_my_rows(
      ...
      unsigned buffer, vector <unsigned> & prev, vector <unsigned> & next
  );
  /**
  ...
  */
  ...
  /** @brief indices of reducers for the corresponding monomials of @c f */
  vector<Abstract_Polynomial *> R;
  /** @brief buffers for building rows */
  vector< vector< COEF_TYPE > > B, RB;
  vector< vector< unsigned > > Rprev, Rnext;
