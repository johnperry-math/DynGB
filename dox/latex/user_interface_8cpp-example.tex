...
\textcolor{keywordtype}{void} \hyperlink{group__utils_ga72d205e8226d578b892515edc527cc83}{user\_interface}() \{
  ...
  \hyperlink{group___fields_group_class_prime___field}{Prime\_Field} F(p);
  ...
  \} \textcolor{keywordflow}{else} \{
    ...
    \textcolor{keywordflow}{while} (
      ...
      and heur\_choice.compare(\textcolor{stringliteral}{"d"}) and heur\_choice.compare(\textcolor{stringliteral}{"r"})
    ) \{
      ...
      cout << \textcolor{stringliteral}{"\(\backslash\)t r = random choice\(\backslash\)n"};
    ...
    \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (not heur\_choice.compare( \textcolor{stringliteral}{"r"})) heuristic = Dynamic\_Heuristic::EVIL\_RANDOM;
  ...
  \}
  \textcolor{comment}{//check\_correctness(B, StrategyFlags::NORMAL\_STRATEGY);}
