\hypertarget{test_f4_8cpp-example}{}\section{test\+\_\+f4.\+cpp}
This illustrates ho wto compute a Gr\"{o}bner basis of the Cyclic-\/ $n$ system \[ x_1 + \cdots + x_n,\\ x_1 x_2 + x_2 x_3 + \cdots + x_n x_1,\\ x_1 x_2 x_3 + x_2 x_3 x_4 + \cdots + x_n x_1 x_2,\\ \vdots\\ x_1 \cdots x_{n-1} + x_2 \cdots x_n + \cdots + x_n x_1 \cdots x_{n-2},\\ x_1 \cdots x_n - 1 \] using this package. This version uses a {\bfseries static} version of Faug\'{e}re's F4 algorithm. See \hyperlink{test__f4__dynamic_8cpp_source}{test\+\_\+f4\+\_\+dynamic.\+cpp} for the dynamic version.
...
\textcolor{comment}{      cout << '\(\backslash\)t' << *(*g) << endl;*/}
    ...
    \textcolor{keyword}{auto} mord = \textcolor{keyword}{static\_cast<}\textcolor{keyword}{const }\hyperlink{group__orderinggroup_class_cached_w_grevlex___ordering}{CachedWGrevlex\_Ordering} *\textcolor{keyword}{>}(
