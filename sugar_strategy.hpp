...
public:
  ...
  */
  ...
  /**
    ...
    @return @p true if and only if the sugar of @p this is equivalent to the
      sugar of @p sd
  */
  virtual bool equivalent(const Poly_Strategy_Data & sd) const override;
  /**
  ...
  */
  ...
  /**
    @brief re-evaluates the sugar, if need be
    @param u Monomial to multiply to @p g, then subtract from @p this
    @param g a polynomial
  */
